        ...
        <section class="home-panel">
            ...
            @if ($savingGoal)
                ...
                <div class="saving-stat-grid saving-stat-grid--home">
                    ...
                    <div class="saving-stat"><span>あと</span><strong>{{ number_format($remainingAmount) }}円</strong></div>
                ...
                @if ($currentBalance >= $savingGoal->target_amount)<p class="home-goal-achieved">🎉 目標達成！</p>@endif
            @else
                <div class="home-empty"><p>まだ貯金目標がありません。</p><a class="button button--primary button--small" href="{{ route('child.savings.show') }}">目標を設定する</a></div>
            @endif
        </section>

        <section class="home-panel">
            <div class="home-panel__heading"><h2>最近の取引</h2><a href="{{ route('child.payment-history.index') }}">支出履歴を見る</a></div>
            @if ($recentTransactions->isEmpty())
                <div class="home-empty"><p>まだ取引履歴がありません。</p></div>
            @else
