                ...
                <div class="chore-setting-display" data-chore-display>
                    ...
                    <div class="card-actions">
                        ...
                        <button
                            ...
                            data-delete-message="「{{ $chore->chore_name }}」を削除しますか？">削除</button>
                    </div>
                </div>

                {{-- お手伝い編集フォーム--}}
                <form class="chore-edit-form" action="{{ route('parent.chores-setting.update', $chore) }}" method="POST" data-chore-edit-form hidden novalidate>
                    @csrf
                    @method('PUT')
                    <div class="form-group">
