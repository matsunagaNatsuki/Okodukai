...
@section('content')
<div class="parent-name page-heading--with-action">
    <img class="child-home-avatar" src="{{ $parent->profile_image ? asset('storage/'.$parent->profile_image) : asset('images/default-profile.svg') }}" alt="{{ $parent->name }}のプロフィール画像">
    <div class="child-home-greeting">
        <span>こんにちは！</span>
        <h1>{{ $parent->name }}さん</h1>
    </div>
</div>
